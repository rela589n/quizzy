...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'exactly_one_checked'        => 'Лише 1 варіант відповіді повинен бути обраний як правильний',
        'some-questions-have-errors' => 'Деякі питання містять помилки!',
        'uri_slug'                   => 'URI-псевдонім може містити лише латинські літери, цифри та дефіси!',
        'mark_percent_map'           => 'Зі збільшенням оцінки, повинні зростати й вимоги (відсотки).',
        'some_configurations_have_errors' => "Деякі налаштування містять помилки!\nВиправте їх.",

        'include.*.count' => [
            'required_with' => 'Якщо ви вибрали цей тест, то обов\'язково вкажіть кількість питань з нього.'
        ],
    ...
    */
    ...
    'attributes' => [
        ...
        'correlation_table'           => 'таблиця оцінювання',
        'custom'                      => 'визначено користувачем',
        'correlation_table.*.mark'    => 'оцінка',
        'correlation_table.*.percent' => 'відсотки'
    ],
];
